...
./scripts/start-infra.sh        # starts PostgreSQL + coturn
./scripts/start-backend.sh      # starts the Spring Boot API

Then in another terminal:

flutter run -d chrome

If the database still has alice and bob from before, you're good. If you wiped it, run:
